    ...
    async function mostrarCards(){
        ...
        if (interno){
            ...
            busqueda.series.forEach(serie => {
                ...
                div.classList.add("movie-card", "cursor-pointer", "bg-steel-blue","3xl:w-[440px]","md:w-[350px]","w-[260px]", "p-4", "rounded-lg", "shadow-lg", "flex", "flex-col", "items-center", "hover:scale-105", "transition");
                div.id = serie.id;
                img.src = !serie.poster ? "../assets/img/poster.jpg" : serie.poster;
                img.alt = "Portada";
                img.classList.add("w-full", "3xl:h-[600px]", "md:h-[440px]", "h-[300px]", "rounded-md", "shadow-md", "object-cover");
